...
-   **Users**: who manage their own money using wallets, policies, and payees.
...
> In short: **Users manage their own funds**, while **developers build apps that can manage funds on their behalf or on behalf of others**.
