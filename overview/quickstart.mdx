...
<Card title="Node.js SDK" icon="js" href="/sdks/node/setup-and-installation">
    Get started with our Node.js SDK and explore advanced features
</Card>

<Card title="Python SDK" icon="python" href="/sdks/python/setup-and-installation">
    Learn how to integrate Payman with your Python applications
</Card>
