...
These funds will be placed in a dedicated wallet specifically for that customer, unless you select a different wallet using the `walletId` property.  
You can have the agent use that wallet to fund activities either by specifying the wallet ID or by providing the same customer ID
when creating tasks.
