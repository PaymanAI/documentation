...
Allow your AI Agent to send payments to bank accounts, crypto wallets, or other agents. Each payment can be configured with approval requirements and tracked through webhooks.
