...
If verification is enabled on a task (see [Customizing Verification](/capabilities/custom-Verification)), only after the submission has been deemed to have
 met all the criteria, the payout is then set to the human who completed it correctly.
